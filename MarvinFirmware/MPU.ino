...
void MPU(){
  ...
  AngleSpeed_y = (accel_t_gyro.value.y_gyro) /FS_SEL;
  ...
  //float alpha = 0.96;
  angle_x = Kalman*gyro_angle_x + (1.0 - Kalman)*accel_angle_x;
  angle_y = Kalman*gyro_angle_y + (1.0 - Kalman)*accel_angle_y;
...
void calibrate_sensors() {
  ...
  //Serial2.println("Finishing Calibration");
